// About Manager for Quotely-Hardy - UPDATED for secure backend
class AboutManager {
    constructor() {
        this.init();
    }
    ...
    async checkAuth() {
        ...
        if (QuotelyAPI && QuotelyAPI.isAuthenticated()) {
    ...
    async handleContactForm(form) {
        ...
        try {
            // Note: We need to add submitContactForm to QuotelyAPI
            // For now, we'll use a simple fetch to our backend
            const response = await fetch(`${QuotelyAPI.API_BASE_URL}/api/contact`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': QuotelyAPI.getAuthHeaders().Authorization || ''
                },
    ...
    loadTeamMembers() {
        // This could be loaded from backend in the future
